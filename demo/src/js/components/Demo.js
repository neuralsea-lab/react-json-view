...
class Demo extends React.PureComponent {
    ...
    render() {
        ...
        return ( < div class = "rjv-demo" >
            <div class = "rjv-header" >
            <div class = "header-1" > react - json - view </div> <div class="header-2" > component demo </div > < img class = "rjv-logo"
            ...
            <div class = "rjv-input" >
            <div class = "rjv-label" > Theme: </div> {this.getThemeInput(theme)} </div > < div class = "rjv-input" >
            <div class = "rjv-label" > Icon Style: </div> {this.getIconStyleInput(iconStyle)} </div >
            <div class = "rjv-input" >
            <div class = "rjv-label" > Enable Edit: </div> {this.getEditInput(onEdit)} </div >
            <div class = "rjv-input" >
            <div class = "rjv-label" > Enable Add: </div> {this.getAddInput(onAdd)} </div> <div class = "rjv-input" >
            <div class = "rjv-label" > Enable Delete: </div> {this.getDeleteInput(onDelete)} </div> <div class = "rjv-input" >
            <div class = "rjv-label" > Enable Clipboard: </div> {this.getEnableClipboardInput(enableClipboard)} </div> </div>

            <div class = "rjv-settings" >
            <div class = "rjv-input" >
            <div class = "rjv-label" > Display Data Types: </div> {this.getDataTypesInput(displayDataTypes)} </div> <div class = "rjv-input" >
            <div class = "rjv-label" > Display Object Size: </div> {this.getObjectSizeInput(displayObjectSize)} </div> <div class = "rjv-input" >
            <div class = "rjv-label" > Indent Width: </div> {this.getIndentWidthInput(indentWidth)} </div> <div class = "rjv-input" >
            <div class = "rjv-label" > Collapsed: </div> {this.getCollapsedInput(collapsed)} </div> <div class = "rjv-input" >
            <div class = "rjv-label" >
            Collapse Strings After Length:
            </div> {this.getCollapsedStringsInput(collapseStringsAfter)} </div> </div>

            { this.getNotes(onEdit, onAdd) } </div>
        );
    }
    ...
    getNotes = (on_edit_enabled, on_add_enabled) => {
        ...
        if (on_edit_enabled) {
            notes.push( <span>
                To edit a value,
                try ctrl / cmd + click enter
                edit mode </span>
            );
            notes.push( <span>
                When editing a value,
                try ctrl / cmd + Enter to
                submit changes </span>
            );
            notes.push( <span>
                When editing a value,
                try Escape  key to cancel </span>
            );
        }
        if (on_add_enabled) {
            notes.push( <span>
                When adding a new key,
                try Enter  to submit </span>
            );
            notes.push( <span>
                When adding a new key,
                try Escape  to cancel </span>
            );
        }
    ...
    getDeleteInput = onDelete => {
        return ( <
            ReactSelect name = "enable-delete"
            value = { onDelete }
            options = {
                [
                    { value: true, label: 'true' },
    ...
    getEnableClipboardInput = enableClipboard => {
        return ( <
            ReactSelect name = "enable-clipboard"
    ...
    getObjectSizeInput = displayObjectSize => {
        return ( <
            ReactSelect name = "display-object-size"
    ...
    getDataTypesInput = displayDataTypes => {
        return ( <
            ReactSelect name = "display-data-types"
    ...
    getCollapsedStringsInput = collapseStringsAfter => {
        return ( <
            ReactSelect name = "collapse-strings"
